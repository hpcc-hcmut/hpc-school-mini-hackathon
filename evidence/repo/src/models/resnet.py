...
from .registry import register_model, resolve_num_classes
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes=100, **kwargs):
        super().__init__()
        num_classes = resolve_num_classes(num_classes, kwargs)
